...
namespace ce103_hw6_calc_app_cs
{
    ...
    class OutputState
    {
        ...
        * @name RenderSeries
        *     
        * @param [in] seriesIndex [\b int]
        * this function is render to the processing of the graphical calculator.
        **/
        ...
        * @param [in] x [\b float]
        * @param [in] y [\b float]
        * In this function our calculator draws text.
        **/
        ...
        *     
        * @param [in] seriesIndex [\b int]
        * This function is about making a pen.
        * Thanks to this function, a pen is formed and the resulting pen draws.
        **/
        ...
        /**
        *
        * @name TryInterpretAsColor
        *     
        * @param [in] color [\b Color]
        * It is the function that interprets the calculator as a color.
        **/
        ...
        * @name DrawLinesSafe
        *     
        * @param [in] points [\b PointF[]]
        * It is a function for drawing secure graphs.
        **/
        ...
        * @param [in] data [\b double[,]]
        * 
        * @param [in] booleanMode [\b bool]
        * 
        * @param [in] trueColor [\b Color]
        **/
        ...
        /**
        *
        * @name RenderContourLines
        *     
        * @param [in] data [\b double[,]]
        * 
        * @param [in] bins [\b sbyte[,]]
        * 
        * @param [in] color [\b Color]
        * @param [in] lo [\b double]
        * @param [in] interval [\b double]
        **/
        ...
        * @param [in] data [\b double[,]]
        * 
        * @param [in] max [\b double]
        * 
        * @param [in] min [\b double]
        **/
    ...
    class GraphRange : CalcRange
    {
        ...
        *     
        * @param [in] lo [\b double]
        * @param [in] hi [\b double]
        * @param [in] pxCount [\b int]
        * @param [in] pen [\b Pen]
        * @param [in] label [\b string]
        **/
        ...
        * @name GraphRange New
        *     
        * @param [in] rangeName [\b string]
        * @param [in] numPixels [\b int]
        **/
